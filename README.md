...
// reading
let raw_pub_key = std::fs::read("tests/assets/signing_keys/public_ed25519.asc")?;
let pkg = rpm::Package::open("tests/assets/RPMS/signed/rpm-basic-with-ed25519-2.3.4-5.el9.noarch.rpm")?;
